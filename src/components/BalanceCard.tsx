...
const BalanceCard = memo(({ balance }: BalanceCardProps) => {
  ...
  return (
    <div className="relative">
      <div className="bg-gradient-to-br from-[#FF9500] via-[#FF8C00] to-[#E07B00] rounded-[2rem] px-4 pt-4 pb-1 text-white shadow-2xl">
      ...
      <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 translate-y-1/2 w-[65%]">
        <button className="w-full bg-white hover:bg-gray-50 text-[#FF8C00] font-bold py-1 px-2 rounded-2xl transition-all shadow-xl flex items-center justify-center gap-3">
