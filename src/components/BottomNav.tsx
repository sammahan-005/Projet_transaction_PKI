...
const BottomNav = memo(() => {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-white pb-safe shadow-lg">
        ...
        <div className="flex items-center justify-around py-4 relative">
          ...
          <button
            ...
            className={`flex flex-col items-center gap-1 transition-colors ${
              isActive('/') ? 'text-[#FF8C00]' : 'text-gray-400 hover:text-gray-600'
            }`}
          >
          ...
          <button
            ...
            className="w-14 h-14 bg-[#FF8C00] rounded-full flex items-center justify-center shadow-xl -mt-6 transition-transform hover:scale-105 hover:bg-[#E07B00]"
          >
